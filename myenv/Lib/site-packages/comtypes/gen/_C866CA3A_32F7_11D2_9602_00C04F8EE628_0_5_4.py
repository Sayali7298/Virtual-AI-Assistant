...
__all__ = [
    'SRTAutopause', 'SpeechLexiconType', 'DISPID_SpeechWaveFormatEx',
    'SpeechEngineProperties', 'DISPID_SpeechGrammarRule',
    'SECFNoSpecialChars', 'SAFTADPCM_44kHzMono', 'SPEI_MIN_TTS',
    'ISpRecognizer3', 'SWPKnownWordPronounceable',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SPAPhraseInfo',
    'eLEXTYPE_PRIVATE10', 'SASPause', 'SPCT_SLEEP',
    'ISpStreamFormatConverter', 'DISPID_SpeechPhraseElement',
    'DISPID_SGRName', 'STSF_AppData', 'SpeechEngineConfidence',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SAFT11kHz16BitMono',
    'DISPID_SpeechRecoContext', 'DISPID_SpeechLexiconWord',
    'SP_VISEME_13', 'SREAllEvents', 'DISPID_SPAsItem',
    'SPPS_SuppressWord', 'SVP_1', 'SPAR_Unknown',
    'DISPID_SVAlertBoundary', 'ISpeechAudio',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SAFTText',
    'ISpeechGrammarRuleStateTransition', 'SVP_2',
    'DISPID_SABIMinNotification', 'ISpXMLRecoResult', 'SPWF_INPUT',
    'ISpRecognizer', 'SVP_11', 'SPPHRASEREPLACEMENT',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SpeechPhraseRule', 'DISPID_SOTCDefault',
    'DISPID_SPILanguageId', 'SPSTREAMFORMATTYPE',
    'DISPID_SGRAddState', 'SGDSInactive', 'DISPID_SPIGetText',
    'ISpeechFileStream', 'DISPID_SRCEventInterests',
    'SpeechMicTraining', 'SPAR_Medium', 'DISPID_SRCCmdMaxAlternates',
    ...
    'DISPID_SRGetPropertyString', 'DISPID_SLPs_NewEnum',
    ...
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SVResume', 'SPSHORTCUTPAIR',
    'SPINTERFERENCE_TOOQUIET', 'SpStreamFormatConverter',
    'DISPID_SVSInputWordLength', 'SPEI_MAX_SR', 'SAFT32kHz16BitMono',
    'SpeechPropertyResponseSpeed', 'DISPID_SOTCreateInstance',
    'SPPS_NotOverriden', 'DISPID_SRCEAudioLevel', 'SVP_4',
    'DISPID_SGRSAddWordTransition', 'DISPID_SVAudioOutput',
    'DISPID_SOTIsUISupported', 'ISpeechLexiconPronunciations',
    '__MIDL_IWinTypes_0009', 'DISPID_SVDisplayUI',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SGRId',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SRARoot', 'DISPID_SRCPause',
    'DISPID_SDKSetLongValue', 'DISPID_SWFEBlockAlign',
    'SPDKL_CurrentConfig', 'DISPID_SLWPronunciations',
    'DISPID_SLPsItem', 'DISPID_SRCRetainedAudio', 'DISPID_SRRTLength',
    'DISPID_SLPType', 'SpeechVoiceEvents',
    'DISPID_SpeechAudioBufferInfo', 'SVP_16',
    'ISpeechPhraseInfoBuilder', 'SAFT24kHz16BitStereo', 'ISpVoice',
    'DISPID_SGRSTRule', 'DISPID_SpeechObjectToken',
    'SpeechVoiceSkipTypeSentence', 'SGSExclusive',
    'DISPID_SPARecoResult', 'SGRSTTTextBuffer', 'SVSFParseSsml',
    'SRATopLevel', 'DISPID_SOTDataKey', 'ISpRecoContext2',
    'SPEI_SENTENCE_BOUNDARY', 'SPGRAMMARSTATE', 'DISPID_SPRsCount',
    'DISPID_SVEWord', 'SVEVoiceChange', 'SRAImport',
    'SPEI_PHRASE_START', 'SP_VISEME_12', 'SpeechVoiceSpeakFlags',
    'tagSTATSTG', 'SVP_10', 'SVSFIsNotXML', 'eLEXTYPE_PRIVATE7',
    'DISPID_SPPChildren', 'DISPID_SRGReset', 'SP_VISEME_5',
    'SAFT11kHz8BitStereo', 'SREPrivate', 'SDTAlternates',
    'SpeechPropertyResourceUsage', 'SpeechDiscardType',
    'SPEI_RESERVED3', 'DISPID_SPPNumberOfElements', 'SLTUser',
    'ISpeechTextSelectionInformation', 'SPEI_RECOGNITION',
    'DISPID_SpeechRecoResultTimes', 'SPINTERFERENCE_TOOLOUD',
    'ISpeechGrammarRuleStateTransitions', 'SPEI_SOUND_START',
    'SPSHORTCUTTYPE', 'SpeechTokenKeyFiles', 'Speech_StreamPos_Asap',
    'DISPID_SDKGetBinaryValue', 'SpeechAudioFormatGUIDWave',
    'SDTReplacement', 'DISPID_SVSRunningState',
    'SPINTERFERENCE_NOSIGNAL', 'SDKLDefaultLocation',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SGRSTPropertyName', 'SVPOver', 'SGRSTTWildcard',
    'SPEI_START_INPUT_STREAM', 'DISPID_SDKSetStringValue',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRRTimes',
    'ISpRecoGrammar2', 'DISPID_SMSADeviceId', 'DISPID_SOTRemove',
    'DISPID_SLWs_NewEnum', 'SPRST_INACTIVE_WITH_PURGE',
    'SPEI_SR_AUDIO_LEVEL', 'SPEVENTSOURCEINFO', 'SPAR_High',
    'SpObjectToken', 'DISPID_SPRFirstElement',
    'DISPID_SVSInputSentenceLength', 'IEnumString',
    'DISPID_SDKEnumKeys', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SpeechRecoResult', 'DISPID_SWFEBitsPerSample',
    'DISPID_SRRGetXMLErrorInfo', 'SPAS_STOP', 'DISPID_SDKOpenKey',
    'SVSFlagsAsync', 'SpeechWordType', 'SFTInput',
    'DISPID_SRCEEndStream', 'SPEI_SR_PRIVATE', 'DISPID_SRGRules',
    'DISPID_SOTCGetDataKey', 'SAFTCCITT_ALaw_11kHzMono',
    'ISpMMSysAudio', 'DISPID_SPEAudioStreamOffset',
    'SpPhoneticAlphabetConverter', 'SVF_None', 'SREHypothesis',
    ...
    'SPEI_SR_RETAINEDAUDIO', 'SINoise',
    'SSSPTRelativeToCurrentPosition', 'SPSMF_SAPI_PROPERTIES',
    'SAFTExtendedAudioFormat', 'ISpeechRecognizerStatus',
    'SP_VISEME_8', 'DISPID_SMSAMMHandle', 'DISPID_SpeechPhraseRules',
    'SAFTADPCM_22kHzStereo', 'SP_VISEME_15', 'SGRSTTEpsilon',
    'SP_VISEME_4', 'DISPID_SPRuleFirstElement',
    'DISPID_SRAudioInputStream',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVSFParseSapi',
    'SPCS_DISABLED', 'DISPID_SVSLastBookmarkId', 'eWORDTYPE_ADDED',
    'DISPID_SPIReplacements', 'SpeechRecognitionType',
    'DISPID_SRSAudioStatus', 'SPCT_COMMAND', 'SpMMAudioIn',
    'DISPID_SpeechBaseStream', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SRSetPropertyNumber', 'SPDKL_LocalMachine',
    'DISPID_SPIAudioStreamPosition', 'SP_VISEME_3',
    'ISpeechRecognizer', 'SPSNotOverriden', 'eLEXTYPE_PRIVATE9',
    'SPGRAMMARWORDTYPE', 'eLEXTYPE_APP', 'SAFT24kHz16BitMono',
    'SPSHT_NotOverriden', 'SAFT32kHz16BitStereo', 'SVSFDefault',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SPANumberOfElementsInResult', 'SDKLCurrentConfig',
    'DISPID_SpeechRecognizerStatus', 'SGRSTTWord',
    'SAFT12kHz8BitMono', 'SPSSuppressWord',
    'DISPID_SpeechAudioStatus', 'DISPID_SRCRequestedUIType',
    'SVSFPersistXML', 'SPWORD', 'WAVEFORMATEX', '_SPAUDIOSTATE',
    'DISPID_SVSVisemeId', 'SPRECORESULTTIMES', 'SPEI_REQUEST_UI',
    'SPRST_ACTIVE', 'SAFTCCITT_uLaw_22kHzStereo', 'SRTReSent',
    'eLEXTYPE_PRIVATE3', 'DISPID_SpeechGrammarRules',
    'DISPID_SRCVoice', 'ISpeechPhraseAlternate', 'STCAll',
    'DISPID_SRSetPropertyString', 'DISPID_SRCreateRecoContext',
    'SPEVENTENUM', 'SpeechPropertyComplexResponseSpeed',
    'SpeechRecoContextState', 'tagSPPROPERTYINFO', 'DISPID_SPPName',
    'SPEI_PROPERTY_STRING_CHANGE', 'SREStateChange',
    'DISPID_SRCERequestUI', 'SAFTGSM610_11kHzMono',
    'SPEI_TTS_BOOKMARK', 'SVEPhoneme', 'DISPID_SLWWord',
    'SAFTCCITT_uLaw_11kHzMono', 'STCInprocServer',
    'DISPID_SDKCreateKey', 'DISPID_SRRSetTextFeedback',
    'DISPID_SASCurrentDevicePosition', 'SAFT44kHz16BitStereo',
    'SpeechAudioFormatType', 'SpeechVoiceCategoryTTSRate',
    'ISpeechVoiceStatus', 'STSF_CommonAppData', 'SPEVENT',
    'SpInprocRecognizer', 'DISPID_SASNonBlockingIO',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SPRsItem', 'SBOPause',
    'DISPID_SPRulesCount', 'ISpeechXMLRecoResult',
    'DISPID_SABufferInfo', 'SAFT32kHz8BitStereo',
    'SpeechSpecialTransitionType', 'SAFTCCITT_uLaw_44kHzMono',
    'SVSFIsFilename', 'SPAS_PAUSE', 'SVPNormal', 'SPWORDTYPE',
    'SVSFIsXML', 'SAFTADPCM_8kHzMono', 'SREAdaptation',
    'DISPID_SVSkip', 'SVEAudioLevel', 'IStream',
    ...
    'SpWaveFormatEx', 'SDA_No_Trailing_Space', 'DISPID_SOTs_NewEnum',
    'ISpLexicon', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SGRsFindRule', 'SVSFParseMask', 'SRADefaultToActive',
    'DISPID_SpeechPhraseBuilder', 'SECFIgnoreWidth',
    'SpPhraseInfoBuilder', 'SPSERIALIZEDRESULT', 'SAFT48kHz8BitMono',
    'SVEBookmark', 'ISpShortcut', 'ISpeechPhraseProperty',
    'SPWF_SRENGINE', 'DISPID_SRGCmdSetRuleState', 'DISPIDSPRG',
    'ISpeechPhraseProperties', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SpeechMemoryStream', 'SpeechTokenShellFolder',
    'ISpeechPhraseInfo', 'DISPID_SLPLangId', 'DISPID_SOTCSetId',
    'SAFTCCITT_ALaw_22kHzStereo', 'SAFTADPCM_11kHzStereo',
    'SRERecoOtherContext', 'DISPIDSPTSI_ActiveLength',
    'SAFT24kHz8BitStereo', 'ISpeechObjectTokenCategory',
    'SPEI_SR_BOOKMARK', 'SpeechAddRemoveWord', 'SPDKL_CurrentUser',
    'SPCT_SUB_DICTATION', 'SPSHT_OTHER', 'SPINTERFERENCE_TOOFAST',
    'SPFM_NUM_MODES', 'SP_VISEME_18', 'SDTPronunciation',
    'DISPID_SVSPhonemeId', 'SpeechGrammarTagUnlimitedDictation',
    'SWPUnknownWordPronounceable', 'SSFMOpenForRead',
    'eLEXTYPE_PRIVATE6', 'DISPID_SRCESoundStart', 'SECHighConfidence',
    'SP_VISEME_20', 'eLEXTYPE_RESERVED9', 'DISPID_SVRate',
    'DISPID_SFSClose', 'DISPID_SPRuleChildren', 'DISPID_SBSFormat',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPIElements',
    'SpeechCategoryPhoneConverters', 'ISpPhoneticAlphabetConverter',
    'ISpSerializeState', 'SGRSTTRule', 'DISPID_SpeechPhraseAlternate',
    'SAFTGSM610_44kHzMono', 'SPCONTEXTSTATE', 'ISpStream', 'SDTAudio',
    'DISPID_SRRTStreamTime', 'SASStop', 'DISPID_SRCRecognizer',
    'SAFT12kHz8BitStereo', 'eLEXTYPE_PRIVATE14', 'SVSFNLPSpeakPunc',
    'DISPID_SRRRecoContext', 'SpeechVoicePriority',
    'SAFTGSM610_22kHzMono', 'SP_VISEME_21', 'SPEI_MAX_TTS',
    'DISPID_SPEDisplayAttributes', 'DISPID_SVSInputSentencePosition',
    'SpeechPartOfSpeech', 'UINT_PTR', 'SASClosed',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPINTERFERENCE_NOISE',
    'DISPID_SABufferNotifySize', 'SGDSActiveWithAutoPause', 'SPRULE',
    'DISPID_SpeechDataKey', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SVStatus', 'LONG_PTR',
    'SPEI_END_INPUT_STREAM', 'eLEXTYPE_PRIVATE13',
    'DISPID_SABIBufferSize', 'SpeechEmulationCompareFlags',
    'DISPID_SOTsItem', 'SVESentenceBoundary',
    'ISpeechLexiconPronunciation', 'SpeechDisplayAttributes',
    'DISPID_SOTCEnumerateTokens', 'eLEXTYPE_PRIVATE11',
    'DISPID_SPAsCount', 'DISPID_SPERequiredConfidence',
    'DISPID_SRGetRecognizers', 'ISpeechMMSysAudio',
    'DISPID_SVGetProfiles', 'SPPS_Noun', 'DISPID_SAFGetWaveFormatEx',
    'ISpRecoGrammar', 'DISPID_SOTsCount', 'DISPID_SGRsCount',
    'DISPID_SRGSetTextSelection', 'ISpPhraseAlt',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SPRuleParent',
    'SAFT48kHz8BitStereo', 'SAFTCCITT_ALaw_44kHzStereo',
    'SVSFParseAutodetect', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SGDSActiveUserDelimited', 'SVP_21', 'SpeechAllElements',
    'DISPID_SVWaitUntilDone', 'DISPID_SGRSRule', 'DISPID_SAStatus',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SVEViseme', 'SPPS_Function',
    'DISPID_SpeechPhraseElements', 'SRTStandard', 'SPVPRI_NORMAL',
    'ISpPhrase', 'SRSActiveAlways', 'DISPID_SAFGuid',
    'eLEXTYPE_PRIVATE20', 'SAFTNoAssignedFormat', 'DISPID_SRCResume',
    'DISPID_SRGState', 'DISPID_SLPPhoneIds', 'SpeechDataKeyLocation',
    ...
    'DISPID_SOTCategory', 'Speech_StreamPos_RealTime',
    'IInternetSecurityManager', 'SpeechUserTraining',
    'DISPID_SRRecognizer', 'SAFT8kHz16BitMono', 'SVP_9',
    'SPPARTOFSPEECH', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SVPause', 'ISpeechAudioBufferInfo', 'SRTExtendableParse',
    'DISPID_SGRSTsCount', 'DISPID_SPIRule',
    'DISPID_SpeechLexiconProns', 'SPPHRASERULE', 'DISPID_SPRuleName',
    'SpeechPropertyLowConfidenceThreshold', 'SPCT_SUB_COMMAND',
    'SpeechStreamFileMode', 'DISPID_SPAs_NewEnum',
    'DISPID_SLRemovePronunciation', 'DISPID_SRCSetAdaptationData',
    'SPAUDIOOPTIONS', 'DISPID_SWFESamplesPerSec',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRAudioInput',
    'STCLocalServer', 'SAFT32kHz8BitMono',
    'DISPID_SVSLastStreamNumberQueued', 'SVEPrivate', 'SPPS_Modifier',
    'SpFileStream', 'SPAO_RETAIN_AUDIO', 'SP_VISEME_0',
    'ISpeechPhraseReplacements', 'DISPID_SpeechVoice',
    'SWPUnknownWordUnpronounceable', 'SpStream', 'SPBO_AHEAD',
    'DISPID_SRCEAdaptation', 'SSFMOpenReadWrite', 'SPEI_UNDEFINED',
    'ISpeechCustomStream', 'SpLexicon', 'ISpEventSource',
    'SVEWordBoundary', 'Speech_Max_Pron_Length',
    'SpeechGrammarTagWildcard', 'SRCS_Enabled',
    'ISpeechPhoneConverter', 'SPSHT_Unknown', 'SAFT16kHz16BitMono',
    'SVP_14', 'DISPID_SPPParent', 'DISPID_SVIsUISupported',
    'DISPID_SpeechVoiceStatus', 'DISPID_SpeechXMLRecoResult',
    'SAFT8kHz8BitStereo', 'SDKLCurrentUser', 'SPSHORTCUTPAIRLIST',
    'SpNullPhoneConverter', 'SPFM_OPEN_READONLY',
    'SAFT22kHz16BitMono', 'SpNotifyTranslator', 'SPFM_CREATE',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SWFEExtraData',
    'SPEI_INTERFERENCE', 'DISPID_SMSALineId', 'DISPID_SPEs_NewEnum',
    'SAFT24kHz8BitMono', 'SPTEXTSELECTIONINFO', 'ISpResourceManager',
    'SRSActive', 'DISPID_SGRSTWeight', 'SRAONone',
    'SAFTADPCM_11kHzMono', 'SpeechRuleAttributes', 'SPSInterjection',
    'DISPID_SLGenerationId', 'SPVPRIORITY',
    'DISPID_SWFEAvgBytesPerSec', 'SPPROPERTYINFO', 'SPSMF_UPS',
    'DISPID_SPCPhoneToId', 'DISPID_SWFEFormatTag',
    'SpResourceManager', 'DISPID_SpeechLexiconWords',
    'SPBOOKMARKOPTIONS', 'DISPID_SLGetGenerationChange',
    'DISPID_SRCRetainedAudioFormat', 'Speech_Max_Word_Length',
    'SVSFPurgeBeforeSpeak', 'SPAUDIOSTATE', 'DISPID_SRCCreateGrammar',
    'DISPID_SPIEnginePrivateData', 'STSF_LocalAppData',
    'SRAInterpreter', 'SPXRO_SML', 'SREStreamStart',
    'ISpeechObjectTokens', 'SPBO_TIME_UNITS', 'ISpAudio',
    'SRERecognition', 'DISPID_SRRGetXMLResult', 'SVSFNLPMask',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpDataKey', 'SDTDisplayText',
    'SGPronounciation', 'DISPID_SRCEInterference',
    'DISPID_SpeechVoiceEvent', 'ISpeechAudioStatus',
    'DISPID_SRCEPropertyNumberChange', 'SWTAdded', 'SPSHT_EMAIL',
    'SPAS_RUN', 'SAFTADPCM_44kHzStereo', 'DISPID_SBSSeek',
    'DISPID_SOTGetStorageFileName', 'STCInprocHandler',
    'DISPID_SPRuleConfidence', 'SPSFunction', 'DISPID_SPIProperties',
    'DISPID_SOTDisplayUI', 'DISPID_SRGRecoContext',
    'DISPID_SRCEFalseRecognition', 'SVP_15', 'SVP_5',
    'DISPID_SPISaveToMemory', '_ISpeechVoiceEvents',
    'SDA_Consume_Leading_Spaces', 'ISpProperties', 'SpPhoneConverter',
    'SPPS_Noncontent', 'DISPID_SRRAudio', 'DISPID_SVEEnginePrivate',
    'SRTEmulated', 'DISPID_SpeechGrammarRuleState',
    'SAFT8kHz8BitMono', 'DISPID_SPPConfidence', 'SPDATAKEYLOCATION',
    'ISpObjectToken', 'SVEViseme', 'DISPID_SRSSupportedLanguages',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SPELexicalForm', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SRCEEnginePrivate', 'SPAO_NONE', 'SITooQuiet',
    'SVEEndInputStream', 'SPRST_ACTIVE_ALWAYS', 'SSTTWildcard',
    'SpeechRetainedAudioOptions', 'DISPID_SPRulesItem', 'SECFDefault',
    'DISPID_SAEventHandle', 'DISPID_SGRsCommit',
    'DISPID_SpeechPhoneConverter', 'SSSPTRelativeToEnd',
    'SAFTGSM610_8kHzMono', 'SVP_7', 'DISPID_SGRSTPropertyId',
    'DISPID_SPEsItem', 'SPEI_MIN_SR', 'SRESoundStart',
    'eLEXTYPE_PRIVATE19', 'SPVPRI_OVER',
    'DISPID_SPIGetDisplayAttributes', 'SRAORetainAudio',
    'SAFT48kHz16BitStereo', 'DISPID_SOTId', 'SPSUnknown',
    'DISPID_SPPEngineConfidence', 'SpeechCategoryVoices',
    'SP_VISEME_19', 'SRSEDone', 'SAFTCCITT_ALaw_44kHzMono',
    'SPWORDPRONUNCIATION', 'DISPID_SGRSTType',
    'DISPID_SDKGetStringValue', 'SVPAlert', 'SPGS_DISABLED',
    'SRAExport', 'SVSFVoiceMask', 'ISpPhoneticAlphabetSelection',
    'SVP_17', 'DISPID_SGRsCommitAndSave', 'SpeechCategoryAudioOut',
    'DISPID_SVEStreamEnd', 'ISpeechGrammarRuleState',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SRRSaveToMemory',
    'IEnumSpObjectTokens', 'SpeechRunState',
    'DISPID_SPEActualConfidence', 'ISpeechRecoResult2',
    'DISPID_SVEBookmark', 'SpeechVisemeFeature',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SLGetPronunciations', 'SPEI_RESERVED5',
    'DISPID_SpeechObjectTokens',
    'DISPID_SpeechGrammarRuleStateTransition',
    'ISpeechResourceLoader', 'DISPID_SAVolume',
    'DISPID_SDKSetBinaryValue', 'DISPID_SPPs_NewEnum',
    'SAFTCCITT_ALaw_22kHzMono', 'SPPS_RESERVED3',
    'DISPID_SGRAddResource', 'SREAudioLevel', 'ISpNotifyTranslator',
    'SLOStatic', 'SAFT8kHz16BitStereo', 'SDTProperty',
    'DISPID_SPPsCount', 'SWTDeleted', 'SAFT12kHz16BitMono',
    'SPLOADOPTIONS', 'DISPID_SRRDiscardResultInfo', 'SPRS_ACTIVE',
    'SPEI_VISEME', 'DISPID_SPRText', 'eLEXTYPE_PRIVATE18', 'SVP_13',
    'DISPID_SpeechPhraseProperty', 'DISPIDSPTSI_SelectionLength',
    'SPEI_PHONEME', 'SREPropertyStringChange', 'SPVISEMES',
    'SpTextSelectionInformation', 'DISPID_SLWType', 'DISPID_SOTCId',
    'DISPID_SPPsItem', 'DISPID_SGRSTransitions',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SGRSTsItem',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPIDSPTSI_SelectionOffset',
    'SPLO_STATIC', 'SVF_Emphasis', 'SAFT44kHz8BitMono',
    'DISPID_SOTGetDescription',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SAFTNonStandardFormat', 'eLEXTYPE_PRIVATE4',
    ...
    'SPSERIALIZEDPHRASE', 'eLEXTYPE_RESERVED4', 'DISPID_SVGetVoices',
    'eLEXTYPE_PRIVATE2', 'STSF_FlagCreate', 'SASRun',
    'SpeechPropertyAdaptationOn', 'DISPID_SASFreeBufferSpace',
    'SpVoice', 'DISPID_SCSBaseStream', 'eLEXTYPE_PRIVATE8',
    'ISpStreamFormat', 'DISPID_SPIRetainedSizeBytes',
    'SpeechGrammarState', 'SpeechCategoryRecognizers',
    'SpAudioFormat', 'SREFalseRecognition',
    'SpeechRecoProfileProperties', 'SpeechRuleState', 'eLEXTYPE_USER',
    'SECLowConfidence', 'SPPS_RESERVED1', 'SREPhraseStart',
    'SAFT16kHz16BitStereo', 'DISPID_SVEStreamStart',
    'SPRS_ACTIVE_USER_DELIMITED', 'eLEXTYPE_RESERVED6',
    'ISpeechDataKey', 'SpeechInterference', 'SGLexical',
    'SPBINARYGRAMMAR', 'DISPID_SLWsCount', 'SPBO_NONE',
    'SECNormalConfidence', 'SSSPTRelativeToStart',
    'DISPID_SABIEventBias', 'ISpeechRecoResult', 'DISPID_SPPId',
    'DISPID_SRSNumberOfActiveRules', 'SPVPRI_ALERT',
    'SpeechCategoryRecoProfiles', 'DISPID_SVESentenceBoundary',
    'ISpRecoCategory', 'SPFM_OPEN_READWRITE', 'SVP_19',
    'SPINTERFERENCE', 'DISPID_SMSSetData', 'SSFMCreateForWrite',
    'DISPID_SpeechLexiconPronunciation', 'ISpeechPhraseRules',
    'SPEI_END_SR_STREAM', 'SRERequestUI', 'DISPID_SGRsDynamic',
    'ISpeechRecoResultDispatch', 'DISPID_SRGetPropertyNumber',
    'SPWORDLIST', 'DISPID_SRCEStartStream', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SGRSTNextState', 'DISPID_SRCERecognizerStateChange',
    'SITooFast', 'DISPID_SPAStartElementInResult', 'SP_VISEME_16',
    'SPGS_EXCLUSIVE', 'SpeechCategoryAudioIn',
    'DISPID_SVAudioOutputStream', 'eWORDTYPE_DELETED', 'SPSVerb',
    'SVEAllEvents', 'DISPID_SRCState', 'DISPID_SPEAudioSizeTime',
    'ISpNotifySink', 'DISPID_SMSGetData',
    'DISPID_SVSInputWordPosition', 'SPPS_Interjection',
    'DISPID_SLAddPronunciationByPhoneIds', 'SFTSREngine',
    'eLEXTYPE_PRIVATE12', 'SDTLexicalForm', 'DISPID_SRRSpeakAudio',
    'DISPID_SGRSTText', 'SPSEMANTICFORMAT',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SREBookmark',
    'DISPID_SASetState', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SRCERecognition', 'SVP_8', 'DISPID_SRRTTickCount',
    'ISpeechBaseStream', 'DISPID_SAFType', 'SpeechWordPronounceable',
    'SGDSActive', 'SPEI_HYPOTHESIS', 'SBONone', 'ISpeechPhraseRule',
    'DISPID_SRGetFormat', '_ISpeechRecoContextEvents', 'SPPHRASE',
    'DISPID_SpeechPhraseInfo', 'SPEI_START_SR_STREAM', 'SP_VISEME_11',
    'SREStreamEnd', 'DISPID_SGRsAdd', 'DISPID_SVSpeakStream',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SECFEmulateResult',
    'ISpeechLexiconWords', 'SPBO_PAUSE', 'SREInterference',
    'DISPID_SPACommit', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SRRAudioFormat', 'eLEXTYPE_PRIVATE16',
    'eLEXTYPE_RESERVED7', 'ISpGrammarBuilder', 'SP_VISEME_10',
    'SGDisplay', 'ISpeechPhraseElements', 'DISPID_SpeechAudio',
    'SVP_18', 'DISPID_SGRSTPropertyValue',
    'SpeechPropertyHighConfidenceThreshold', 'SVEStartInputStream',
    'SDA_One_Trailing_Space', 'DISPID_SWFEChannels',
    'ISpeechGrammarRules', 'SAFTADPCM_8kHzStereo', 'SP_VISEME_7',
    'DISPID_SRCEBookmark', 'DISPID_SRState', 'SPPS_RESERVED4',
    'ISpeechPhraseElement', 'eLEXTYPE_RESERVED8',
    'DISPID_SRDisplayUI', 'SPWT_LEXICAL', 'SPCT_DICTATION',
    'SAFT16kHz8BitMono', 'SP_VISEME_14', 'DISPID_SVSLastResult',
    'SPAUDIOBUFFERINFO', 'SAFTDefault', 'SVF_Stressed', 'SPSLMA',
    'DISPID_SGRSAddSpecialTransition',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SpMemoryStream',
    'SPRULESTATE', 'SAFT12kHz16BitStereo', 'SPEI_RESERVED2',
    'ISpeechGrammarRule', 'DISPID_SRGCmdSetRuleIdState',
    'SP_VISEME_17', 'DISPID_SVEPhoneme', 'SPFM_CREATE_ALWAYS',
    'SPSNoun', 'SP_VISEME_9', 'SRSInactiveWithPurge',
    'DISPID_SADefaultFormat', 'SPPS_RESERVED2', 'SAFT48kHz16BitMono',
    'ISpeechMemoryStream', 'DISPID_SVVoice', 'DISPID_SPRuleId',
    'DISPID_SLPSymbolic', 'DISPID_SRGDictationLoad', 'SPPS_Verb',
    'SAFTADPCM_22kHzMono', 'DISPID_SGRClear', 'SpeechTokenValueCLSID',
    'SPEI_ADAPTATION', 'SGLexicalNoSpecialChars', 'DISPID_SRIsShared',
    'DISPID_SREmulateRecognition', 'DISPID_SPCIdToPhone',
    'DISPID_SRGDictationUnload', 'SPCATEGORYTYPE', 'SPRST_NUM_STATES',
    'SAFT22kHz8BitStereo', 'SPRECOGNIZERSTATUS', 'SPPS_LMA',
    '_RemotableHandle', 'DISPID_SpeechCustomStream',
    'DISPID_SLPPartOfSpeech', 'ISpeechRecoResultTimes',
    'DISPID_SPEPronunciation', 'SECFIgnoreKanaType',
    'SpInProcRecoContext', 'SSTTTextBuffer', 'SRTSMLTimeout',
    'DISPID_SDKDeleteKey', 'SPLO_DYNAMIC',
    'DISPID_SLAddPronunciation', 'DISPID_SRGId', 'SVP_3',
    'DISPID_SVGetAudioInputs', 'DISPID_SpeechRecoResult2',
    'SPAUDIOSTATUS', 'ISpObjectWithToken',
    'DISPID_SRCCreateResultFromMemory', 'SPSModifier',
    'DISPID_SPIStartTime', 'DISPID_SRStatus', 'SAFT44kHz8BitStereo',
    'SPPHRASEELEMENT', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRRTOffsetFromStart', 'SpMMAudioEnum', 'STCRemoteServer',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SVSLastBookmark',
    'SPDKL_DefaultLocation', 'SpeechRecognizerState',
    'DISPID_SRRAlternates', 'DISPID_SpeechPhraseProperties',
    'DISPID_SRProfile', 'SpObjectTokenCategory', 'SGSDisabled',
    'SPCS_ENABLED', 'SVP_6', 'SPEI_RESERVED1',
    'SAFTCCITT_ALaw_8kHzStereo', 'SpSharedRecognizer',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPIEngineId',
    'DISPID_SPERetainedStreamOffset', 'SAFT22kHz16BitStereo',
    'ISpeechPhraseAlternates', 'DISPID_SDKEnumValues',
    'SPXMLRESULTOPTIONS', 'SpeechLoadOption', 'DISPID_SBSWrite',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SOTMatchesAttributes',
    'eLEXTYPE_PRIVATE5', 'SpUnCompressedLexicon', 'SDTAll',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRRPhraseInfo',
    'DISPID_SPRDisplayAttributes', 'ISpeechAudioFormat',
    'eLEXTYPE_PRIVATE17', 'SDTRule', 'DISPID_SpeechLexicon', 'SVP_12',
    'DISPID_SLWLangId', 'SLTApp', 'DISPID_SVVolume',
    'IInternetSecurityMgrSite', 'DISPID_SLPsCount', 'SpShortcut',
    'SpeechRegistryUserRoot', 'DISPID_SPIAudioSizeTime',
    'ISpeechLexicon', 'SDKLLocalMachine',
    'SAFTCCITT_uLaw_44kHzStereo', 'SP_VISEME_1', 'ISpRecoResult',
    'SPLEXICONTYPE', 'SITooSlow', 'DISPID_SVEVoiceChange',
    'SP_VISEME_2', 'SPSEMANTICERRORINFO', 'DISPID_SBSRead',
    'ISpRecognizer2', 'DISPID_SRGCmdLoadFromResource',
    'SPADAPTATIONRELEVANCE', 'SPEI_WORD_BOUNDARY', 'SPEI_SOUND_END',
    'DISPID_SpeechFileStream', 'ISequentialStream', 'SGRSTTDictation',
    'DISPIDSPTSI', 'SRSEIsSpeaking', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SOTGetAttribute', 'SVP_0', 'DISPID_SPEDisplayText',
    'SAFT11kHz8BitMono', 'SSFMCreate', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SVEAudioLevel', 'DISPID_SASState',
    'DISPID_SRSClsidEngine', 'DISPID_SPEsCount', 'DISPID_SPCLangId',
    'DISPID_SPRs_NewEnum', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPPHRASEPROPERTY', 'ISpEventSink', 'DISPID_SPPFirstElement',
    'SINone', 'ISpeechLexiconWord', 'SPGS_ENABLED',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SDKDeleteValue',
    'ISpeechVoice', 'SpeechBookmarkOptions', 'SRESoundEnd',
    'SpeechTokenKeyUI', 'SRADynamic',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SVPriority',
    'SpeechStreamSeekPositionType', 'SPEI_TTS_PRIVATE',
    'SpeechTokenIdUserLexicon', 'DISPIDSPTSI_ActiveOffset',
    'SINoSignal', 'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SLGetWords',
    'DISPID_SRCEHypothesis', 'SPEI_RESERVED6', 'SPWAVEFORMATTYPE',
    'SPWORDPRONOUNCEABLE', 'DISPID_SPPValue',
    'DISPID_SRGIsPronounceable', 'SpMMAudioOut', 'SAFT22kHz8BitMono',
    'SpCustomStream', 'ISpeechObjectToken', 'DISPID_SDKGetlongValue',
    'SLODynamic', 'ISpRecoContext', 'SPINTERFERENCE_NONE',
    'SSTTDictation', 'ISpObjectTokenCategory',
    'DISPID_SPEAudioTimeOffset',
    'DISPID_SRCAudioInInterferenceStatus', 'SPRST_INACTIVE',
    'DISPID_SGRInitialState', 'SPRS_INACTIVE', 'SpSharedRecoContext',
    'SPEI_PROPERTY_NUM_CHANGE', 'eLEXTYPE_RESERVED10',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SpeechMMSysAudio',
    'SREPropertyNumChange', 'SPFILEMODE', 'SVP_20',
    'DISPID_SRGCommit', 'SP_VISEME_6', 'SAFT16kHz8BitStereo',
    'SpeechTokenContext', 'SpeechGrammarWordType',
    'DISPID_SVEventInterests',
    'DISPID_SRCERecognitionForOtherContext', 'SPRECOSTATE',
    'ISpNotifySource', 'SpeechAudioState', 'SPPS_Unknown',
    'Speech_Default_Weight', 'eLEXTYPE_PRIVATE1',
    'SAFT44kHz16BitMono', 'DISPID_SGRsItem', 'SPWT_PRONUNCIATION',
    'SGSEnabled', 'SpeechAudioProperties', 'SPXRO_Alternates_SML',
    'DISPID_SLWsItem', 'SPAS_CLOSED', 'SpeechRecoEvents',
    'tagSPTEXTSELECTIONINFO', 'SVSFUnusedFlags', 'SPAR_Low',
    'SITooLoud', 'ISpPhoneConverter', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SpeechRecognizer',
